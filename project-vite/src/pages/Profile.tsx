...
const [searchParams] = useSearchParams();
  ...
  useEffect(() => {
    ...
    const cardholderId = params.id || searchParams.get('id') as string || state.currentUser?.cardholderId;
  ...
  }, [params.id || searchParams.get('id'), state.currentUser, state.cardholders, router]);
