// functions/src/handlers/adminAuth.ts
...
export const createAdmin = (req: Request, res: Response): Promise<void> | void => {
...
// Admin login
export const adminLogin = (req: Request, res: Response): Promise<void> | void => {
  corsHandler(req, res, async (): Promise<void> => {
    if (req.method === 'OPTIONS') {
      res.status(200).end();
      return;
...
export const verifyAdminToken = (req: Request, res: Response): Promise<void> | void => {
  corsHandler(req, res, async (): Promise<void> => {
    if (req.method === 'OPTIONS') {
      res.status(200).end();
      return;
